...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _EXTERNALINTERFACE.methods_by_name['EnrollFace']._options = None
  _EXTERNALINTERFACE.methods_by_name['EnrollFace']._serialized_options = b'\202\323\344\223\002\024\"\017/v1/enroll_face:\001*'
  ...
  _EXTERNALINTERFACE.methods_by_name['CancelBehavior']._options = None
  _EXTERNALINTERFACE.methods_by_name['CancelBehavior']._serialized_options = b'\202\323\344\223\002\030\"\023/v1/cancel_behavior:\001*'
  ...
  _EXTERNALINTERFACE.methods_by_name['GetCameraConfig']._options = None
  _EXTERNALINTERFACE.methods_by_name['GetCameraConfig']._serialized_options = b'\202\323\344\223\002\032\"\025/v1/get_camera_config:\001*'
  ...
  _EXTERNALINTERFACE.methods_by_name['SetCameraSettings']._options = None
  _EXTERNALINTERFACE.methods_by_name['SetCameraSettings']._serialized_options = b'\202\323\344\223\002\034\"\027/v1/set_camera_settings:\001*'
  _EXTERNALINTERFACE.methods_by_name['AppIntent']._options = None
  _EXTERNALINTERFACE.methods_by_name['AppIntent']._serialized_options = b'\202\323\344\223\002\023\"\016/v1/app_intent:\001*'
  _EXTERNALINTERFACE.methods_by_name['UpdateSettings']._options = None
  _EXTERNALINTERFACE.methods_by_name['UpdateSettings']._serialized_options = b'\202\323\344\223\002\030\"\023/v1/update_settings:\001*'
  _EXTERNALINTERFACE.methods_by_name['GetLatestAttentionTransfer']._options = None
  _EXTERNALINTERFACE.methods_by_name['GetLatestAttentionTransfer']._serialized_options = b'\202\323\344\223\002&\"!/v1/get_latest_attention_transfer:\001*'
  _EXTERNALINTERFACE.methods_by_name['PullJdocs']._options = None
  _EXTERNALINTERFACE.methods_by_name['PullJdocs']._serialized_options = b'\202\323\344\223\002\023\"\016/v1/pull_jdocs:\001*'
  _EXTERNALINTERFACE.methods_by_name['UpdateAccountSettings']._options = None
  _EXTERNALINTERFACE.methods_by_name['UpdateAccountSettings']._serialized_options = b'\202\323\344\223\002 \"\033/v1/update_account_settings:\001*'
  _EXTERNALINTERFACE.methods_by_name['StartUpdateEngine']._options = None
  _EXTERNALINTERFACE.methods_by_name['StartUpdateEngine']._serialized_options = b'\202\323\344\223\002\034\"\027/v1/start_update_engine:\001*'
  _EXTERNALINTERFACE.methods_by_name['CheckUpdateStatus']._options = None
  _EXTERNALINTERFACE.methods_by_name['CheckUpdateStatus']._serialized_options = b'\202\323\344\223\002\034\"\027/v1/check_update_status:\001*'
  _EXTERNALINTERFACE.methods_by_name['UpdateAndRestart']._options = None
  _EXTERNALINTERFACE.methods_by_name['UpdateAndRestart']._serialized_options = b'\202\323\344\223\002\033\"\026/v1/update_and_restart:\001*'
  _EXTERNALINTERFACE.methods_by_name['CheckCloudConnection']._options = None
  _EXTERNALINTERFACE.methods_by_name['CheckCloudConnection']._serialized_options = b'\202\323\344\223\002\037\"\032/v1/check_cloud_connection:\001*'
  _EXTERNALINTERFACE.methods_by_name['GetFeatureFlag']._options = None
  _EXTERNALINTERFACE.methods_by_name['GetFeatureFlag']._serialized_options = b'\202\323\344\223\002\025\"\020/v1/feature_flag:\001*'
  _EXTERNALINTERFACE.methods_by_name['GetFeatureFlagList']._options = None
  _EXTERNALINTERFACE.methods_by_name['GetFeatureFlagList']._serialized_options = b'\202\323\344\223\002\032\"\025/v1/feature_flag_list:\001*'
  _EXTERNALINTERFACE.methods_by_name['GetAlexaAuthState']._options = None
  _EXTERNALINTERFACE.methods_by_name['GetAlexaAuthState']._serialized_options = b'\202\323\344\223\002\031\"\024/v1/alexa_auth_state:\001*'
  _EXTERNALINTERFACE.methods_by_name['AlexaOptIn']._options = None
  _EXTERNALINTERFACE.methods_by_name['AlexaOptIn']._serialized_options = b'\202\323\344\223\002\025\"\020/v1/alexa_opt_in:\001*'
  _PROTOCOLVERSION._serialized_start=368
  _PROTOCOLVERSION._serialized_end=479
  _EXTERNALINTERFACE._serialized_start=482
  _EXTERNALINTERFACE._serialized_end=14138
